...
class Data2vec(nn.Module):
    ...
    def __init__(self, encoder, cfg, **kwargs):
        ...
        self.embed_dim = cfg.model.embed_dim #regression head에서 맞춰줄 embed dimension
        ...
        self.cfg = cfg
        self.ema_decay = self.cfg.model.ema_decay #논문 기준 시작하는 T값(0.999)
        self.ema_end_decay = self.cfg.model.ema_end_decay #논문 기준 시작하는 T값(0.9999)
        self.ema_anneal_end_step = self.cfg.model.ema_anneal_end_step #얼마에 걸쳐서 decay값을 변경할지
